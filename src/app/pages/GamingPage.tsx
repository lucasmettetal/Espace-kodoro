      ...
      >
        ...
        <div style={{ maxWidth: 1280, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '1rem' }}>
            ...
            <a
              href="https://discord.gg/NjgAVECMR"
              target="_blank"
              rel="noopener noreferrer"
              style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', border: '1px solid rgba(88,101,242,0.5)', background: 'rgba(88,101,242,0.12)', color: '#A8B0FF', fontFamily: "'DM Sans', sans-serif", fontSize: '0.875rem', fontWeight: 500, letterSpacing: '0.04em', textTransform: 'uppercase', textDecoration: 'none', padding: '0.75rem 2rem', transition: 'border-color 0.2s, background 0.2s' }}
              onMouseEnter={e => { e.currentTarget.style.borderColor = 'rgba(88,101,242,0.9)'; e.currentTarget.style.background = 'rgba(88,101,242,0.22)'; }}
              onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(88,101,242,0.5)'; e.currentTarget.style.background = 'rgba(88,101,242,0.12)'; }}
            >
      ...
      <section style={{ background: '#5F3636', padding: 'clamp(4rem, 8vw, 7rem) clamp(2rem, 8vw, 8rem)', textAlign: 'center' }}>
        <div style={{ maxWidth: 700, margin: '0 auto' }}>
          ...
          <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 'clamp(0.9rem, 1.5vw, 1rem)', lineHeight: 1.8, color: 'rgba(244,239,228,0.7)', marginBottom: '2rem' }}>
            Rejoins la communauté gaming de Caussade : annonces des prochaines dates, discussions,
            organisation et partage de matériel.
          </p>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '1rem' }}>
            <a
              href="https://discord.gg/NjgAVECMR"
              target="_blank"
              rel="noopener noreferrer"
              style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', background: '#5865F2', color: '#fff', fontFamily: "'DM Sans', sans-serif", fontSize: '0.875rem', fontWeight: 600, letterSpacing: '0.04em', textTransform: 'uppercase', textDecoration: 'none', padding: '0.75rem 2rem', transition: 'background 0.2s' }}
            ...
            <a
              ...
              target={cfg.gaming_whatsapp_link ? '_blank' : undefined}
              rel="noopener noreferrer"
              style={{ display: 'inline-block', border: '1px solid rgba(244,239,228,0.3)', color: 'rgba(244,239,228,0.75)', fontFamily: "'DM Sans', sans-serif", fontSize: '0.875rem', fontWeight: 500, letterSpacing: '0.04em', textTransform: 'uppercase', textDecoration: 'none', padding: '0.75rem 2rem', transition: 'border-color 0.2s' }}
              onMouseEnter={e => (e.currentTarget.style.borderColor = '#C9A700')}
              onMouseLeave={e => (e.currentTarget.style.borderColor = 'rgba(244,239,228,0.3)')}
            >
              Groupe WhatsApp
            </a>
          </div>
